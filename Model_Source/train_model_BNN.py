...
for ep in range(Epochs):
    ...
    # Check if accuracy decreased and adjust learning rate
    if BiAccuracy <= prev_accuracy:
        LearningRate *= 0.95  # Decrease learning rate by 5%
        print("Decreasing learning rate to:", LearningRate)

    prev_accuracy = BiAccuracy
...
weights_params = {"Wh": Wo, 
                  "bh": bo, 
                  "Wo": Wh, 
                  "bo": bh}

# Save the dictionary to a .npy file
np.save("BNN_relu.npy", weights_params)
